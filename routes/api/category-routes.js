...
router.get('/:id', async (req, res) => {
  ...
  try {
    const singleCategoryData = await Category.findByPk(req.params.id,{ include: [{ model :Product}] });
    ...
    console.log(`Error in /api/categories/${req.params.id}`);
...
router.delete('/:id', (req, res) => {
  ...
  try {
    const deletedCategory=  Category.destroy ({where:{ id: req.params.id}});
